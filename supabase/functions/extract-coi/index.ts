...
serve(async (req) => {
    ...
    try {
        ...
        console.log(`Received COI extraction request for file: ${file_path}, mime: ${mime_type}`);
        ...
        const prompt = `
      Extract the following details from this Certificate of Incorporation (COI) or related company document:
      - Company Identification Number (as "cin")
      - Permanent Account Number (as "pan")
      - Tax Deduction and Collection Account Number (as "tan")
      - Registered Address (as "address")
